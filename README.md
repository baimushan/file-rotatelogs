...
[![Build Status](https://travis-ci.org/baimushan/file-rotatelogs.png?branch=master)](https://travis-ci.org/baimushan/file-rotatelogs)

[![GoDoc](https://godoc.org/github.com/baimushan/file-rotatelogs?status.svg)](https://godoc.org/github.com/baimushan/file-rotatelogs)
...
import (
  ...
  rotatelogs "github.com/baimushan/file-rotatelogs"
)
...
```
go get github.com/baimushan/file-rotatelogs
```
...
such as `github.com/baimushan/apache-logformat`.

```go
import(
  "log"
  "github.com/baimushan/file-rotatelogs"
)
